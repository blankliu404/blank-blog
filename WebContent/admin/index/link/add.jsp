    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">新增友情锻接</span>
            </div>
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="/blog/admin/index/link/add" method="post">
                        <div class="form-group">
                            <label for="lname" class="col-sm-2 control-label no-padding-right">友情锻接名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="请填写友情链接名称" name="lname" type="text" required="required">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="请填写友情链接地址" name="link" type="text" required="required">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">

                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="/blog/admin/index">系统</a>
                                        ...
                                        <li>
                        <a href="/blog/admin/index/link/list">友情锻接管理</a>
                    </li>
                                        <li class="active">修改友情锻接</li>
                                        </ul>
                </div>
                <!-- /Page Breadcrumb -->
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">修改友情锻接</span>
            </div>
            <div class="widget-body">
                <div id="horizontal-form">
                   <form class="form-horizontal" role="form" action="/blog/admin/index/link/edit?lid=${link.lid }" method="post">
                        <div class="form-group">
                            <label for="lname" class="col-sm-2 control-label no-padding-right">友情锻接名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" value="${link.lname }" placeholder="" name="lname" type="text" required="required">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            <label for="link" class="col-sm-2 control-label no-padding-right">友情锻接地址</label>
                            <div class="col-sm-6">
                                <input class="form-control" value="${link.link }"  placeholder="" name="link" type="text" required="required">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">

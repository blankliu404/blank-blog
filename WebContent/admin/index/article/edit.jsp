        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                   <form class="form-horizontal" role="form" action="/blog/admin/index/article/edit?aid=${article.aid}" method="post">
                        <div class="form-group">
                            <label for="title" class="col-sm-2 control-label no-padding-right">文章标题</label>
                            <div class="col-sm-6">
                                <input class="form-control" value="${article.title}"  placeholder="请输入文章标题" name="title"  required="required" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            <label for="time" class="col-sm-2 control-label no-padding-right">发布时间</label>
                            <div class="col-sm-6">
                                <input class="form-control" disabled="disabled" value="${Time.timeShift(article.createTime)}"  type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" value="${article.keyword}"  placeholder="请填入关键词" name="keyword" type="text" required="required">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea name="breviary" class="form-control" required="required" style="resize: none">${article.breviary}</textarea>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-xs-4">
                                <label>
                                    ...
                                    <c:if test="${article.origin eq true}">checked="checked"</c:if>>
                            ...
                            <div class="col-sm-6">
                                <select name="classification" required="required"> 
                                    <c:forEach items="${classificationList}" var="cl">	
                                    	<option <c:if test="${article.cid eq cl.cid}">selected="selected"</c:if> value="${cl.cid}">${cl.cname}</option>                               	
  									</c:forEach>
                                </select>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea id="container" name="content" required="required">${article.content}</textarea>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">

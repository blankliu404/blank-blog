...
<button type="button" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '/blog/admin/index/classification/add'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                            	<c:forEach var="cl" items="${classList}">
     	                            <tr>
                                        <td align="center">${cl.cid}</td>
                                        <td align="center">${cl.cname}</td>
                                        <td align="center">
                                            <a href="/blog/admin/index/classification/edit?cid=${cl.cid}" class="btn btn-primary btn-sm shiny">
                                                <i class="fa fa-edit"></i> 编辑
                                            </a>
                                            <a href="#" onClick="warning('确实要删除分类${cl.cname}吗?', '/blog/admin/index/classification/delete?cid=${cl.cid}')" class="btn btn-danger btn-sm shiny">
